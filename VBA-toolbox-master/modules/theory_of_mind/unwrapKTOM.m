...
% ==============================================================
% 4. ⬆️ NEW SECTION: store computed variables into UserData
% ==============================================================
dataStruct = struct();
dataStruct.p_sophistication = Pk;   % posterior P(op = k')
dataStruct.prediction       = Po;   % opponent's next-move prob
dataStruct.mP               = mP;   % mean of opponent params
dataStruct.vP               = vP;   % var  of opponent params
dataStruct.K                = K;
dataStruct.nTrials          = nt;
set(hf, 'UserData', dataStruct);    % attach to figure handle
